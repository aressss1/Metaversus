...
const ExploreCard = ({ id , imgUrl , title , index, active , handleClick  }) => (
  ...
  {active !== id ? (
        //If img is not active then rendering Non active img title in -90deg 
    <h3
